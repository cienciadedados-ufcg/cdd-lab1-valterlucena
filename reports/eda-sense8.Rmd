...
Ver sobre quais séries a base de dados possui informações.
...
Escolhendo as séries. critério: séries que possuem numero de temporadas semelhantes.
Quais séries? Game of thrones, Friends, Black Mirror.

```{r}
episodes_series = episodes %>% 
    filter(series_name %in% c("Game of Thrones", "American Horror Story", "Breaking Bad"))
...
# Avaliações dos usuários ao longo da duração da série.
