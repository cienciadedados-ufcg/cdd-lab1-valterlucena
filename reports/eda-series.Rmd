...
escolhidas %>% 
    ...
    ggplot(aes(x = Série, y = user_rating, color = Série)) +
...
Para ajudar a responder esta pergunta, vamos visualizar a distribuição das notas a partir de outro gráfico, o *box-plot* (todo: explicar o box). 
...
Como podemos observar, as notas de metade dos episódios de *Breaking Bad* e *Game of Thrones* são maiores que a maioria das notas dos episódios de *American Horror Story*. Assim, é possível concluir que *American Horror Story* não é a série mais bem avaliada entre as escolhidas.
