...
```{r}
# Retira American Horror Story das séries analisadas.
...
candidatas %>% 
    ...
    ylab("Usuários (%) ") +
    ggtitle("Proporção de episódio que foram avaliados como nota mínima (1)")
...
candidatas %>% 
    ...
    xlab("Número do Episódio") +
    ylab("Usuários (%)") +
    ggtitle("Proporção de episódio que foram avaliados como nota máxima (10)")
```
