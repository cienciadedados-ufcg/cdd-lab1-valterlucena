...
#Comentários
  ...
  Muito bom relatório, parabéns! As explicações foram boas e o texto foi bem escrito, facilitando muito entender o raciocínio utilizado. A abordagem para conectar a pergunta que foi gerada com a pergunta da mesma foi muito boa também. Como sugestão, tentei mostrar uma outra forma para aplicar a legenda, sem precisar modificar o nome da variável, mas o resultado final é o mesmo do seu.